...
{
    /// <summary>
    /// An implementation of IPopulationEvaluator that evaluates all 
    /// genomes (new or already evaluated)
    /// within the population in a single thread, 
    /// using an INetworkEvaluator provided at construction time.
    /// 
    /// This class provides an IPopulationEvaluator for use 
    /// within the EvolutionAlgorithm by simply
    /// providing an INetworkEvaluator to its constructor. This usage 
    /// is intended for experiments
    ...
    /// </summary>
    public class EveryonePopulationEvaluator : IPopulationEvaluator
    {
		...
		#region Constructor
        public EveryonePopulationEvaluator()
            : this(null, null)
        {
        }
