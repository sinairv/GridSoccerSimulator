...
namespace NeuralNetwork
{
    ...
    public class ActivationNetwork : Network
    {
        ...
        public void SetLayerActivationFunction(IActivationFunction function, int layerIndex)
        {
            ((ActivationLayer)layers[layerIndex]).SetActivationFunction(function);
        }

        public void SetLastLayerActivationFunction(IActivationFunction function)
        {
            SetLayerActivationFunction(function, layers.Length - 1);
            //((ActivationLayer)layers[layerIndex]).SetActivationFunction(function);
        }
