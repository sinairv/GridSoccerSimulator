...
{
    public class CCEANEATFFCtrlQTable : NeatQTableBase
    {
        ...
        public CCEANEATFFCtrlQTable(RLClientBase client, int numTeammates, int myUnum)
        ...
        public override IExperiment CreateExperiment()
        {
            ...
            return new CCEANEATFFCtrlExperiment(this, 4,
