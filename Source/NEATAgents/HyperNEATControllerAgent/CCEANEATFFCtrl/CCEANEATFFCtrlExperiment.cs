...
namespace GridSoccer.HyperNEATControllerAgent.CCEANEATFFCtrl
{
    public class CCEANEATFFCtrlExperiment : IExperiment
    {
        ...
        public CCEANEATFFCtrlExperiment(NeatQTableBase qTable, int numCPPNInputs, int numCPPNOutputs)
        {
        ...
        public void ResetEvaluator(IActivationFunction activationFn)
        {
            populationEvaluator = new
                EveryonePopulationEvaluator(new CCEANEATFFCtrlNetworkEvaluator(m_neatQTable));
        }
